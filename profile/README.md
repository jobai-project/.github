...
🌐 **Service** : [app.jobai.site](https://app.jobai.site/)  
🎨 **Figma** : [View Design](https://www.figma.com/design/AsERHFCsxURAQ9sPOgStTe/TAVE-17%EA%B8%B0-%ED%94%84%EB%A1%9C%EC%A0%9D%ED%8A%B8---JOBA-?node-id=1-4&p=f&t=aYWaUvtCBu8jylaV-0)
...
- **매칭 근거 제시** — 적합도 점수의 근거를 함께 제공해 신뢰성을 높여요
...
- 🗂️ **지원 현황 트래커** — 스크랩한 공고의 지원 단계·면접 일정을 자동 정리하고 다가오는 일정 요약
...
### ⚙️ Backend
<div>                                                                                               <img src="https://img.shields.io/badge/Java 21-007396?style=flat-square&logo=openjdk&logoColor=white">                                        
